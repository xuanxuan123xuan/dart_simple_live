...
class KuaishouWebLoginPage extends GetView<KuaishouWebLoginController> {
  ...
  Widget build(BuildContext context) {
    // The WebView session must be cleaned before the route is allowed to pop.
              ...
              child: Utils.isOhos
                  ...
                  : InAppWebView(
                      ...
                      initialSettings: InAppWebViewSettings(
                        ...
                        // iOS CookieManager only reads the default data store.
                        // Backup-session isolation is managed by the controller.
                        incognito: false,
                        sharedCookiesEnabled: !controller.requiresFreshSession,
